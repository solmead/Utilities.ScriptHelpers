...
import { FieldChange } from "../../physical/InvSquareField";
...
export class Wall extends PhysicalNode {
    constructor(line, width = 6, effectDistance = 100) {
        super();
        this.line = line;
        this.width = width;
    ...
    calculationBetweenNodes(curNode, field) {
        ...
        var mag1 = curNode.getValue("_" + field.fieldName);
        var mass2 = this.mass;
        var mag2 = this.getValue("_" + field.fieldName);
